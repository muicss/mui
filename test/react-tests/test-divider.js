...
describe('react/divider', function() {
  ...
  it('renders properly with additional classNames', function() {
    let result = getShallowRendererOutput(<Divider className="additional">test</Divider>);

    assert.equal(result.props.className, 'mui-divider additional');
  });

  it('renders properly with additional styles', function() {
    let result = getShallowRendererOutput(<Divider style={{additonal: 'style'}}>test</Divider>);
